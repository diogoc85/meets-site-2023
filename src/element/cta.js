			...
			<div className="container cta">
				<div className="row action-box style-1 shadow rounded align-items-center m-mob">
					...
					<div className="col-xl-4 col-lg-4 col-md-4 center-mob">
						<a href="/teste-gratis/" className="btn btn-primary btn-round" data-aos="fade-right" data-aos-duration="400" target="_blank">Começar o Teste <i className="fa fa-angle-right m-l10"></i></a>
					</div>
				</div>
			</div>
		</section>
